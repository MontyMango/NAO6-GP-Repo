...
###################
	...
	# speech.
        ...
        self.listening_movement_proxy = ALProxy("ALListeningMovement", ip, port)
...
################
    def set_initial_posture(self):
        ...
        self.listening_movement_proxy.setEnabled(False) # Disable listening movement
        self.autonomous_life.setAutonomousAbilityEnabled("ListeningMovement", False)
        ...
        # Optionally, lock stiffness to legs/torso so NAO stays stable
        #leg_joints = ["LKneePitch", "LAnklePitch", "LAnkleRoll",
        #      "RKneePitch", "RAnklePitch", "RAnkleRoll",
        #      "Torso"]
        #self.motion.stiffnessInterpolation(leg_joints, 1.0, 1.0)
        ...
        try:
            ...
            while True:
                ...
                if (energy > energy_threshold and energy < upper_energy_threshold):
                    ...
                    #self.player.run("animations/Stand/Gestures/Thinking_1")
                    #self.posture.goToPosture("Stand", 1.0)
                    #leg_joints = ["LHipYawPitch", "LHipRoll", "LHipPitch", "LKneePitch", "LAnklePitch", "LAnkleRoll",
                    #  "RHipYawPitch", "RHipRoll", "RHipPitch", "RKneePitch", "RAnklePitch", "RAnkleRoll",
                    #  "Torso"]
            ...
            while True:
                ...
                if time.time() - last_sound_time >= silence_threshold:
                    ...
                    #self.player.run("animations/Stand/BodyTalk/Speaking/BodyTalk_1")
...
################################
    def graceful_exit(self):
        ...
        self.autonomous_life.setAutonomousAbilityEnabled("ListeningMovement", False)
        self.listening_movement_proxy.setEnabled(True)
...
try:
    while True:
        ...
        #nao_chatbot.player.run("animations/Stand/BodyTalk/Speaking/BodyTalk_2")
        # Generate a random number between 1 and 22
        num = random.randint(1, 22)
        ...
        # Execute the command
        subprocess.call(cmd, shell=True)
        #nao_chatbot.posture.goToPosture("Stand", 1.0)
        #leg_joints = ["LHipYawPitch", "LHipRoll", "LHipPitch", "LKneePitch", "LAnklePitch", "LAnkleRoll",
        #      "RHipYawPitch", "RHipRoll", "RHipPitch", "RKneePitch", "RAnklePitch", "RAnkleRoll",
        #      "Torso"]
        #nao_chatbot.motion.stiffnessInterpolation(leg_joints, 1.0, 1.0)
        nao_chatbot.autonomous_life.setAutonomousAbilityEnabled("ListeningMovement", False)
